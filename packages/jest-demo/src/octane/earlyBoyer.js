...
*/
function sc_equal(x) {
  for (var i = 1; i < arguments.length; i++) if (x !== arguments[i]) return false;
  return true;
}
...
function sc_gcd() {
  var gcd = 0;
  for (var i = 0; i < arguments.length; i++) gcd = sc_euclid_gcd(gcd, arguments[i]);
  return gcd;
}
...
function sc_consStar() {
  ...
  for (var i = arguments.length - 2; i >= 0; i--) res = new sc_Pair(arguments[i], res);
  return res;
}
...
function sc_append() {
  ...
  var res = arguments[arguments.length - 1];
  for (var i = arguments.length - 2; i >= 0; i--) res = sc_dualAppend(arguments[i], res);
  return res;
}
...
function sc_appendBang() {
  var res = null;
  for (var i = 0; i < arguments.length; i++) res = sc_dualAppendBang(res, arguments[i]);
  return res;
}
...
function sc_jsstring2list(s) {
  var res = null;
  for (var i = s.length - 1; i >= 0; i--) res = sc_cons(new sc_Char(s.charAt(i)), res);
  return res;
}
...
function sc_callWithValues(producer, consumer) {
  ...
  if (produced instanceof sc_Values) return consumer.apply(null, produced.values);
    ...
    if (c === '\\') {
      ...
      switch (tmp.length) {
        case 0: // it's escaping a whitespace char:
          if (sc_isEOFObject(port.peekChar)) return new sc_Token(13 /*ERROR*/, 'bad #-pattern2.');
    ...
    while (true) {
      ...
      switch (token.type) {
        ...
        case 6 /*CLOSE_BRACKET*/:
          ...
          } else throw "closing par doesn't match: " + listBeginType + ' ' + listEndType;
...
function sc_prepWriteCircle(o, symb, nbPointer) {
  ...
  if (o instanceof sc_Pair || o instanceof sc_Vector) {
    ...
    if (o instanceof sc_Pair) {
      ...
      for (var i = 0; i < o.length; i++) sc_prepWriteCircle(o[i], symb, nbPointer);
    }
  }
}

function sc_genToWriteCircleString(o, symb) {
  if (!(o instanceof sc_Pair || o instanceof sc_Vector)) return sc_toWriteString(o);
...
var sc_const_4_nboyer;
{
  sc_const_4_nboyer = new sc_Pair(
    ...
    new sc_Pair(
      new sc_Pair(
        '\u1E9Cand',
        new sc_Pair(
          new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cand',
              new sc_Pair(
                new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))),
                new sc_Pair(
                  new sc_Pair(
                    '\u1E9Cand',
                    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cw', null))),
        null,
      ),
    ),
  );
  sc_const_3_nboyer = sc_list(
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Ccodegen',
                new sc_Pair(
                  new sc_Pair('\u1E9Coptimize', new sc_Pair('\u1E9Cform', null)),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Ceqp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cequal',
            new sc_Pair(
              new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cx', null)),
              new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cy', null)), null),
            ),
          ),
          null,
        ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cgreaterp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))),
          null,
        ),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Clesseqp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cnot',
            new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cgreatereqp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cnot',
            new sc_Pair(
              new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
              null,
            ),
          ),
          null,
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Cequal',
                new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Ct', null), null)),
              ),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cequal',
                  new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cf', null), null)),
                ),
                null,
              ),
            ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Ciff', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))),
                null,
              ),
            ),
          ),
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                ...
                new sc_Pair(
                  new sc_Pair(
                    '\u1E9Codd',
                    new sc_Pair(new sc_Pair('\u1E9Csub1', new sc_Pair('\u1E9Cx', null)), null),
                  ),
                  null,
                ),
              ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Ccountps-', new sc_Pair('\u1E9Cl', new sc_Pair('\u1E9Cpred', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ccountps-loop',
            new sc_Pair(
              '\u1E9Cl',
              new sc_Pair('\u1E9Cpred', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)),
            ),
          ),
          null,
        ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cfact-loop', new sc_Pair('\u1E9Ci', new sc_Pair(1, null))),
          null,
        ),
      ),
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Creverse-loop',
            new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Cnil', null), null)),
          ),
          null,
        ),
      ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cdivides', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Czerop',
            new sc_Pair(
              new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))),
              null,
            ),
          ),
          null,
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Ccons',
                new sc_Pair('\u1E9Cvar', new sc_Pair(new sc_Pair('\u1E9Ct', null), null)),
              ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Ccons',
                new sc_Pair('\u1E9Cvar', new sc_Pair(new sc_Pair('\u1E9Cf', null), null)),
              ),
              new sc_Pair('\u1E9Calist', null),
            ),
          ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Cnot',
                new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cx', null)), null),
              ),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cnot',
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cand', new sc_Pair('\u1E9Cp', new sc_Pair('\u1E9Cq', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cor', new sc_Pair('\u1E9Cp', new sc_Pair('\u1E9Cq', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cimplies', new sc_Pair('\u1E9Cp', new sc_Pair('\u1E9Cq', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair('\u1E9Cx', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)),
            ),
          ),
          null,
        ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cif',
              new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null))),
            ),
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cif',
                  new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cd', new sc_Pair('\u1E9Ce', null))),
                ),
                new sc_Pair(
                  new sc_Pair(
                    '\u1E9Cif',
                    new sc_Pair('\u1E9Cc', new sc_Pair('\u1E9Cd', new sc_Pair('\u1E9Ce', null))),
                  ),
                  null,
                ),
              ),
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cnot',
                  new sc_Pair(new sc_Pair('\u1E9Cnumberp', new sc_Pair('\u1E9Cx', null)), null),
                ),
                null,
              ),
            ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cplus',
          new sc_Pair(
            new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
            new sc_Pair('\u1E9Cz', null),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              '\u1E9Cx',
              new sc_Pair(
                new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))),
                null,
              ),
            ),
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair(
            new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
            new sc_Pair(new sc_Pair('\u1E9Czero', null), null),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cb', null)), null),
            ),
          ),
          null,
        ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cx', null))),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null),
      ),
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
            new sc_Pair(
              new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cc', null))),
              null,
            ),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cc', null)), null),
            ),
          ),
          null,
        ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
              null,
            ),
          ),
        ),
              ...
              new sc_Pair(
                new sc_Pair(
                  ...
                  new sc_Pair(
                    ...
                    new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cy', null)), null),
                  ),
                ),
                null,
              ),
        ...
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cplus-tree',
              new sc_Pair(
                new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
                null,
              ),
            ),
            new sc_Pair('\u1E9Ca', null),
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cmeaning',
                  new sc_Pair(
                    new sc_Pair('\u1E9Cplus-tree', new sc_Pair('\u1E9Cy', null)),
                    new sc_Pair('\u1E9Ca', null),
                  ),
                ),
                null,
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cplus-tree',
              new sc_Pair(new sc_Pair('\u1E9Cplus-fringe', new sc_Pair('\u1E9Cx', null)), null),
            ),
            new sc_Pair('\u1E9Ca', null),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cfix',
            new sc_Pair(
              new sc_Pair('\u1E9Cmeaning', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))),
              null,
            ),
          ),
          null,
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              '\u1E9Cx',
              new sc_Pair(
                new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))),
                null,
              ),
            ),
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Creverse',
          new sc_Pair(
            new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
            null,
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Creverse', new sc_Pair('\u1E9Ca', null)), null),
            ),
          ),
          null,
        ),
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cplus',
            new sc_Pair(
              new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cz', null))),
                null,
              ),
            ),
          ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              '\u1E9Cx',
              new sc_Pair(
                new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))),
                null,
              ),
            ),
          ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cmc-flatten', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cappend',
            new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cor',
            new sc_Pair(
              new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cb', null))),
                null,
              ),
            ),
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Cx',
            new sc_Pair(new sc_Pair('\u1E9Creverse', new sc_Pair('\u1E9Cy', null)), null),
          ),
        ),
        new sc_Pair(
          new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
          null,
        ),
      ),
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clength',
          new sc_Pair(new sc_Pair('\u1E9Creverse', new sc_Pair('\u1E9Cx', null)), null),
        ),
        new sc_Pair(new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Cx', null)), null),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Ca',
            new sc_Pair(
              new sc_Pair('\u1E9Cintersect', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null))),
              null,
            ),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cand',
            new sc_Pair(
              new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cc', null))),
                null,
              ),
            ),
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cnth',
          new sc_Pair(new sc_Pair('\u1E9Czero', null), new sc_Pair('\u1E9Ci', null)),
        ),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null),
      ),
    ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Ci',
            new sc_Pair(
              new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Ck', null))),
              null,
            ),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Ctimes',
            new sc_Pair(
              new sc_Pair('\u1E9Cexp', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cj', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Cexp', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Ck', null))),
                null,
              ),
            ),
          ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Ci',
            new sc_Pair(
              new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Ck', null))),
              null,
            ),
          ),
        ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Creverse-loop', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cappend',
            new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Cz',
            new sc_Pair(
              new sc_Pair('\u1E9Csort-lp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
              null,
            ),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cplus',
            new sc_Pair(
              new sc_Pair('\u1E9Ccount-list', new sc_Pair('\u1E9Cz', new sc_Pair('\u1E9Cx', null))),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Ccount-list',
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
            new sc_Pair(
              new sc_Pair('\u1E9Cappend', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cc', null))),
              null,
            ),
          ),
        ),
        new sc_Pair(
          new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null))),
          null,
        ),
      ),
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cplus',
          new sc_Pair(
            new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
            new sc_Pair(
              new sc_Pair(
                '\u1E9Ctimes',
                new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cx', null)), null),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cbig-plus1',
              new sc_Pair('\u1E9Cl', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cbase', null))),
            ),
        ...
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              ...
              new sc_Pair(
                '\u1E9Cx',
                new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cbase', null))),
              ),
            ),
            new sc_Pair('\u1E9Cbase', null),
          ),
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cy', new sc_Pair(1, null))),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null),
      ),
    ),
    new sc_Pair(
    ...
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cremainder', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cx', null))),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null),
      ),
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clessp',
          new sc_Pair(
            new sc_Pair('\u1E9Cquotient', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cj', null))),
            new sc_Pair('\u1E9Ci', null),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Cnot',
                new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Ci', null)), null),
              ),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cor',
                  new sc_Pair(
                    ...
                    new sc_Pair(
                      new sc_Pair(
                        '\u1E9Cnot',
                        new sc_Pair(
                          new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cj', new sc_Pair(1, null))),
                          null,
                        ),
                      ),
                      null,
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cpower-eval',
          new sc_Pair(
            new sc_Pair('\u1E9Cpower-rep', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cbase', null))),
            new sc_Pair('\u1E9Cbase', null),
          ),
        ),
        new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Ci', null)), null),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                ...
                new sc_Pair(
                  ...
                  new sc_Pair(new sc_Pair('\u1E9Czero', null), new sc_Pair('\u1E9Cbase', null)),
                ),
              ),
            ),
            new sc_Pair('\u1E9Cbase', null),
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cj', null))),
          null,
        ),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Cgcd', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair('\u1E9Cgcd', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))),
          null,
        ),
      ),
    ),
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cappend',
            new sc_Pair(
              new sc_Pair('\u1E9Cnth', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Ci', null))),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cnth',
                  new sc_Pair(
                    ...
                    new sc_Pair(
                      new sc_Pair(
                        ...
                        new sc_Pair(
                          '\u1E9Ci',
                          new sc_Pair(
                            new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Ca', null)),
                            null,
                          ),
                        ),
                      ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cdifference',
          new sc_Pair(
            new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))),
            new sc_Pair('\u1E9Cx', null),
          ),
        ),
        new sc_Pair(new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cy', null)), null),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
            new sc_Pair(
              new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cz', null))),
              null,
            ),
          ),
        ),
        new sc_Pair(
          new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))),
          null,
        ),
      ),
    ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Cx',
            new sc_Pair(
              new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cc', new sc_Pair('\u1E9Cw', null))),
              null,
            ),
          ),
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cdifference',
            new sc_Pair(
              new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cc', new sc_Pair('\u1E9Cx', null))),
              new sc_Pair(
                new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cw', new sc_Pair('\u1E9Cx', null))),
                null,
              ),
            ),
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cb', new sc_Pair('\u1E9Cc', null))),
          null,
        ),
      ),
    ),
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair('\u1E9Cy', null)), null),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cz', null))),
          null,
        ),
      ),
    ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Cnot',
                new sc_Pair(new sc_Pair('\u1E9Czerop', new sc_Pair('\u1E9Cz', null)), null),
              ),
              new sc_Pair(
                new sc_Pair('\u1E9Clessp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
                null,
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair('\u1E9Cvalue', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))),
          null,
        ),
      ),
    ),
        ...
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Ccons',
                new sc_Pair('\u1E9Cy', new sc_Pair(new sc_Pair('\u1E9Cnil', null), null)),
              ),
              null,
            ),
          ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
                null,
              ),
            ),
          ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Clistp',
          new sc_Pair(new sc_Pair('\u1E9Cgopher', new sc_Pair('\u1E9Cx', null)), null),
        ),
        new sc_Pair(new sc_Pair('\u1E9Clistp', new sc_Pair('\u1E9Cx', null)), null),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
        new sc_Pair('\u1E9Csamefringe', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cequal',
            new sc_Pair(
              new sc_Pair('\u1E9Cflatten', new sc_Pair('\u1E9Cx', null)),
              new sc_Pair(new sc_Pair('\u1E9Cflatten', new sc_Pair('\u1E9Cy', null)), null),
            ),
          ),
          null,
        ),
            ...
            new sc_Pair(
              new sc_Pair(
                ...
                new sc_Pair(
                  ...
                  new sc_Pair(
                    new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cy', new sc_Pair(1, null))),
                    null,
                  ),
                ),
              ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cx', new sc_Pair(1, null))), null),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Ctimes-list', new sc_Pair('\u1E9Cy', null)), null),
            ),
          ),
          null,
        ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(new sc_Pair('\u1E9Cprime-list', new sc_Pair('\u1E9Cy', null)), null),
            ),
          ),
          null,
        ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            '\u1E9Cz',
            new sc_Pair(
              new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cw', new sc_Pair('\u1E9Cz', null))),
              null,
            ),
          ),
        ),
              ...
              new sc_Pair(
                new sc_Pair(
                  ...
                  new sc_Pair(
                    new sc_Pair(
                      '\u1E9Cequal',
                      new sc_Pair('\u1E9Cz', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)),
                    ),
                    new sc_Pair(
                      new sc_Pair('\u1E9Cequal', new sc_Pair('\u1E9Cw', new sc_Pair(1, null))),
                      null,
                    ),
                  ),
                ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cremainder',
          new sc_Pair(
            new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Cy', new sc_Pair('\u1E9Cx', null))),
            new sc_Pair('\u1E9Cy', null),
          ),
        ),
        new sc_Pair(new sc_Pair('\u1E9Czero', null), null),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cequal',
          new sc_Pair(
            new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
            new sc_Pair(1, null),
          ),
        ),
        new sc_Pair(
          sc_list(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cequal',
                  new sc_Pair('\u1E9Ca', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)),
                ),
                null,
              ),
            ),
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cequal',
                  new sc_Pair('\u1E9Cb', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)),
                ),
                null,
              ),
            ),
        ...
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Clength',
              new sc_Pair(
                new sc_Pair('\u1E9Cdelete', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cl', null))),
                null,
              ),
            ),
            new sc_Pair(new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Cl', null)), null),
          ),
        ),
        new sc_Pair(
          new sc_Pair('\u1E9Cmember', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cl', null))),
          null,
        ),
      ),
    ),
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              '\u1E9Cx',
              new sc_Pair(new sc_Pair('\u1E9Csort2', new sc_Pair('\u1E9Cl', null)), null),
            ),
          ),
          null,
        ),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        ...
        new sc_Pair(new sc_Pair('\u1E9Csort2', new sc_Pair('\u1E9Cx', null)), null),
      ),
    ),
    new sc_Pair(
      '\u1E9Cequal',
      new sc_Pair(
                                    ...
                                    new sc_Pair(
                                      ...
                                      new sc_Pair(
                                        ...
                                        new sc_Pair(
                                          new sc_Pair(
                                            '\u1E9Ccons',
                                            new sc_Pair('\u1E9Cx6', new sc_Pair('\u1E9Cx7', null)),
                                          ),
                                          null,
                                        ),
                                      ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              6,
              new sc_Pair(new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Cx7', null)), null),
            ),
          ),
          null,
        ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cadd1',
              new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair('\u1E9Cx', null)), null),
            ),
            new sc_Pair(2, null),
          ),
        ),
        ...
        new sc_Pair(
          new sc_Pair(
            ...
            new sc_Pair(
              '\u1E9Cx',
              new sc_Pair(
                new sc_Pair('\u1E9Cquotient', new sc_Pair('\u1E9Cy', new sc_Pair(2, null))),
                null,
              ),
            ),
          ),
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                ...
                new sc_Pair(
                  '\u1E9Ci',
                  new sc_Pair(new sc_Pair('\u1E9Cadd1', new sc_Pair('\u1E9Ci', null)), null),
                ),
              ),
              new sc_Pair(2, null),
            ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
            new sc_Pair(
              new sc_Pair('\u1E9Cdifference', new sc_Pair('\u1E9Cz', new sc_Pair('\u1E9Cy', null))),
              null,
            ),
          ),
        ),
                        ...
                        new sc_Pair(
                          new sc_Pair(
                            ...
                            new sc_Pair(
                              new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cx', null)),
                              new sc_Pair(
                                new sc_Pair('\u1E9Cfix', new sc_Pair('\u1E9Cz', null)),
                                null,
                              ),
                            ),
                          ),
        ...
        new sc_Pair(
          ...
          new sc_Pair(
            new sc_Pair(
              '\u1E9Cplus-tree',
              new sc_Pair(
                new sc_Pair('\u1E9Cdelete', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Cy', null))),
                null,
              ),
            ),
            new sc_Pair('\u1E9Ca', null),
    ...
    new sc_Pair(
      ...
      new sc_Pair(
        new sc_Pair(
          '\u1E9Cnth',
          new sc_Pair(new sc_Pair('\u1E9Cnil', null), new sc_Pair('\u1E9Ci', null)),
        ),
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
                        ...
                        new sc_Pair(
                          ...
                          new sc_Pair(
                            new sc_Pair(
                              '\u1E9Ccar',
                              new sc_Pair(
                                new sc_Pair('\u1E9Clast', new sc_Pair('\u1E9Ca', null)),
                                null,
                              ),
                            ),
                            new sc_Pair('\u1E9Cb', null),
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cequal',
                  new sc_Pair(new sc_Pair('\u1E9Ct', null), new sc_Pair('\u1E9Cz', null)),
                ),
                new sc_Pair(
                  new sc_Pair(
                    '\u1E9Cequal',
                    new sc_Pair(new sc_Pair('\u1E9Cf', null), new sc_Pair('\u1E9Cz', null)),
                  ),
                  null,
                ),
              ),
      ...
      new sc_Pair(
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
              new sc_Pair('\u1E9Cassignedp', new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null))),
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cassignment',
                  new sc_Pair('\u1E9Cx', new sc_Pair('\u1E9Ca', null)),
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Ccar',
                  new sc_Pair(new sc_Pair('\u1E9Cflatten', new sc_Pair('\u1E9Cx', null)), null),
                ),
                new sc_Pair(new sc_Pair('\u1E9Czero', null), null),
              ),
            ),
      ...
      new sc_Pair(
        new sc_Pair(
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              new sc_Pair(
                '\u1E9Cset',
                new sc_Pair('\u1E9Ci', new sc_Pair('\u1E9Cval', new sc_Pair('\u1E9Cmem', null))),
              ),
              null,
            ),
          ),
        ...
        new sc_Pair(
          new sc_Pair(
            '\u1E9Cif',
            new sc_Pair(
              new sc_Pair('\u1E9Ceqp', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Ci', null))),
              new sc_Pair(
                '\u1E9Cval',
                new sc_Pair(
                  new sc_Pair('\u1E9Cget', new sc_Pair('\u1E9Cj', new sc_Pair('\u1E9Cmem', null))),
                  null,
                ),
              ),
            ),
          ...
          new sc_Pair(
            ...
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair(
                  '\u1E9Cplus',
                  new sc_Pair('\u1E9Cc', new sc_Pair(new sc_Pair('\u1E9Czero', null), null)),
                ),
                null,
              ),
            ),
          ...
          new sc_Pair(
            new sc_Pair(
              ...
              new sc_Pair(
                new sc_Pair('\u1E9Ctimes', new sc_Pair('\u1E9Ca', new sc_Pair('\u1E9Cb', null))),
                new sc_Pair(
                  new sc_Pair('\u1E9Cplus', new sc_Pair('\u1E9Cc', new sc_Pair('\u1E9Cd', null))),
                  null,
                ),
              ),
            ),
                  ...
                  new sc_Pair(
                    new sc_Pair(
                      ...
                      new sc_Pair(
                        '\u1E9Ca',
                        new sc_Pair(
                          new sc_Pair('\u1E9Clength', new sc_Pair('\u1E9Cb', null)),
                          null,
                        ),
                      ),
                    ),
  ...
  translate_term_nboyer = function (term) {
    ...
    return !(term instanceof sc_Pair)
      ...
      : new sc_Pair(
          ...
          lst === null
            ? null
            : new sc_Pair(translate_term_nboyer(lst.car), translate_args_nboyer(lst.cdr))),
        );
  };
    ...
    return alist === null
      ...
      : new sc_Pair(
          ...
          sc_alist_6 === null
            ? null
            : new sc_Pair(
                new sc_Pair(sc_alist_6.car.car, translate_term_nboyer(sc_alist_6.car.cdr)),
  ...
  apply_subst_nboyer = function (alist, term) {
    ...
    var temp_temp;
    return !(term instanceof sc_Pair)
      ? ((temp_temp = sc_assq(term, alist)), temp_temp !== false ? temp_temp.cdr : term)
      : new sc_Pair(
          term.car,
          ((lst = term.cdr),
          lst === null
  ...
  tautologyp_nboyer = function (sc_x_11, true_lst, false_lst) {
    ...
    while (true) {
      if (
        ...
        sc_tmp1126_10 !== false ? sc_tmp1126_10 : is_term_member_nboyer(sc_x_11, true_lst)) !==
        false
      )
        return true;
      else if (
        ((sc_tmp1125_9 = is_term_equal_nboyer(sc_x_11, false_term_nboyer)),
        sc_tmp1125_9 !== false ? sc_tmp1125_9 : is_term_member_nboyer(sc_x_11, false_lst)) !== false
      )
        return false;
        ...
        if (
          ...
          tmp1126 !== false ? tmp1126 : is_term_member_nboyer(sc_x_8, true_lst)) !== false
        )
          sc_x_11 = sc_x_11.cdr.cdr.car;
        else if (
          ((x = sc_x_11.cdr.car),
          (tmp1125 = is_term_equal_nboyer(x, false_term_nboyer)),
          tmp1125 !== false ? tmp1125 : is_term_member_nboyer(x, false_lst)) !== false
        )
    ...
    var sc_lst_13;
    {
      ...
      if (!(term instanceof sc_Pair)) return term;
        ...
        sc_term_12 = new sc_Pair(
          ...
          sc_lst_13 === null
            ? null
            : new sc_Pair(rewrite_nboyer(sc_lst_13.car), rewrite_args_nboyer(sc_lst_13.cdr))),
        );
  ...
  rewrite_args_nboyer = function (lst) {
    ...
    return lst === null
      ...
      : new sc_Pair(
          ...
          sc_lst_14 === null
            ? null
            : new sc_Pair(rewrite_nboyer(sc_lst_14.car), rewrite_args_nboyer(sc_lst_14.cdr))),
        );
  };
    ...
    var sc_term_22;
    {
      ...
      sc_term_21 = apply_subst_nboyer(
        const_nboyer === null
          ? null
          : new sc_Pair(
              new sc_Pair(const_nboyer.car.car, translate_term_nboyer(const_nboyer.car.cdr)),
        ...
        ((BgL_sc_defzd2loop_9zd2 = function (defs, sc_nts_11) {
          ...
          return defs instanceof sc_Pair
            ? ((def = defs.car),
                  ...
                  while (l instanceof sc_Pair) {
                    {
                      ...
                      l = l.cdr;
                      sc_nts_13 =
                        sc_member(nt, sc_nts_13) !== false ? sc_nts_13 : new sc_Pair(nt, sc_nts_13);
                    }
                  }
              ...
              rule_loop(
                def.cdr,
                sc_member(head, sc_nts_11) !== false ? sc_nts_11 : new sc_Pair(head, sc_nts_11),
              ))
          ...
          return defs instanceof sc_Pair
            ? ((def = defs.car),
              (rule_loop = function (rules, BgL_sc_nbzd2confs_15zd2) {
                ...
                } else return BgL_sc_defzd2loop_6zd2(defs.cdr, BgL_sc_nbzd2confs_15zd2);
              }),
        ...
        var BgL_sc_nbzd2derivzd2treesza2_48za2;
        {
          ...
          conf_set_adjoin = function (state, conf_set, sc_conf_56, i) {
            ...
            return (
              ...
              (conf_set[tail + 5] = i),
              (conf_set[3] = i),
              tail < 0 ? ((conf_set[0] = state[0]), (state[0] = sc_conf_56)) : undefined
            );
          };
          ...
          BgL_sc_confzd2setzd2adjoinza2za2_46z00 = function (
            ...
            return (
              ...
              ((conf_set = state[sc_conf_63 + 1]), conf_set !== false ? conf_set[i + 5] : false) !==
              false
                      ...
                      while (l instanceof sc_Pair) {
                        {
                          ...
                          if (
                            ...
                            conf_set !== false ? conf_set[BgL_sc_statezd2num_68zd2 + 5] : false) !==
                            false
                          ) {
                            next = sc_conf_80 + 1;
